 ...
 *
 * Most React src have pure render functions.
 *
 * Example:
 *
 ...
 * differences. Only mixin to src which have simple props and state, or
  ...
  createElement: function (type, props, children) {
    ...
    if (!validType) {
      if (typeof type !== 'function' && typeof type !== 'string') {
        ...
        "development" !== 'production' ? warning(false, 'React.createElement: type is invalid -- expected a string (for ' + 'built-in src) or a class/function (for composite ' + 'src) but got: %s.%s', type == null ? type : typeof type, info) : void 0;
      }
    }
 ...
 * src. This is now being replaced with an opaque data structure.
...
var ReactFragment = {
  ...
  create: function (object) {
    ...
    !(object.nodeType !== 1) ? "development" !== 'production' ? invariant(false, 'React.addons.createFragment(...): Encountered an invalid child; DOM elements are not valid children of React src.') : _prodInvariant('0') : void 0;
